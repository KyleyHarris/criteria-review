...
| [`criteria-present`](skills/claude-code/criteria-present/SKILL.md) | Building and auditing the product-shaped walkthroughs a customer is shown, and placing new scenarios into them |
